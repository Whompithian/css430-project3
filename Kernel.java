/*
 * @file    Kernel.java
 *           Modified from ThreadOS distribution file Kernel.java
 * @brief   This version of the ThreadOS kernel has been modified to support a
 *           SyncQueue for threads waiting on events or I/O. The SyncQueue is
 *           used to avoid busy waiting and allow better resource utilization
